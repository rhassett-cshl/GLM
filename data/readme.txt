...
All the columns after "score" are columns for summerized features. For example, "ctcf" means the normalized column of the feature "Transcription factor CTCF binding".
